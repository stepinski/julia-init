...
# ╔═╡ 145e95fb-718f-462e-946f-2e7a14065f87
using Dates
...
# ╔═╡ 7e4fae1c-801c-11ec-06dd-f17298ed3d5c
velocity = CSV.read(
    "./NE004CAL_17_velocity.csv", DataFrame;
    delim=',', 
    missingstring="NA", 
    decimal='.',  
    types=Dict(:time => DateTime, :value => Float64)
)

# ╔═╡ 16a05827-e15a-49ac-bbf5-5b27cc51edac
rain = CSV.read(
    "./NE004CAL_17_rain.csv", DataFrame;
    delim=',', 
    missingstring="NA", 
    decimal='.',  
    types=Dict(:time => DateTime, :value => Float64)
...
md"""
 - We'd like to clean resample the data and fill NaNs  
